...
<section class="first-section" id="braces-top">
	<div class="container">
		<div class="row ">
			<div class ="col-md-12 success img-responsive ">
				<div class ="col-xs-10 col-xs-offset-1 col-sm-6 col-sm-offset-3  top-quote callout-white">	
					<h1>Success stories</h1>
					<p>In need of some inspiration? These stories are from people like you,people who are determined not to let the pain of knee osteoarthritis hold them back.Take control and get set for the adventure ahead.</p>
				</div>
			</div>
		</div>
	</div>
...
<section id="success-stories-1" class="">
        ...
        <div class="row row-centered">
			...
			<div class="col-xs-12 col-sm-6 success-text col-centered success-text-top">  

					<p><q>Staying active is a huge priority in my life, and I am able to do so much more by wearing this brace. When I had my microfracture surgery almost 2 years ago, my  orthopedic surgeon told me that  my running days were over. When I wear this brace, I am able to get on the treadmill and run for 6 miles. </q></p>
					<h3 class="hidden-xs">Jeffrey W.</h3>
		    ...
		    <div class="col-xs-7  success-text visible-xs">  
					<h3>Jeffrey W.</h3>
					<h4>Weigthlifter</h4>
			</div>
...
<section id="success-stories-3" class="">
        <div class="container brace-section accordion-backrg ">
          <div class="row row-centered">
			...
			<div class="col-xs-12 col-sm-6 success-text col-centered success-text-top">  
					<p><q>If I’m going to be on my feet all day  I make sure I wear the Unloader One so my knee won’t bother me.  Since the Unloader One is working for me, surgery on my left knee could be delayed forever.</q></p>
					<h3 class="hidden-xs">Lawrence F.</h3>
...
<section id="success-stories-4" class="">
        ...
        <div class="row">
				...
				<div class="col-xs-12 col-sm-5 col-sm-offset-2 success-text">  
					<p><q>I want to tell you how grateful I am for this Unloader One brace.  My knee had become so painful, I feared I was facing a knee replacement.  With this brace, I am PAIN FREE.  I do everything with it, including walking, biking, and Pilates!</q></p>
					<h3 class="hidden-xs">Joan W.</h3>
...
<section id="success-stories-5" class="">
        ...
        <div class="row row-centered">
				...
				<div class="col-xs-12 col-sm-6 success-text col-centered success-text-top">  
					<p><q>The Unloader Fit, the Unloader One, and the CTi OA enable me to do all the things I love to do.  Skiing, wake surfing, wakeboarding, biking, golfing, and hiking in the Rocky Mountains are all possible with the use of the braces. The allow me to live my life without limitations!</q></p>
					<h3 class="hidden-xs">Ken R.</h3>
					<h4 class="hidden-xs">Cycling, Wakeboarding, Running</h4>
				</div>
				 ...
				 <div class="col-xs-7 success-text visible-xs">  
					<h3>Ken R.</h3>
					<h4>Cycling, Wakeboarding, Running</h4>
			</div>
				</div>
				    ...
				    <div class="modal-dialog">
				        <div class="modal-content">
				            ...
				            <div class="modal-body">
				                <img id="image-gallery-image" class="img-responsive modal-img " src="">
				            </div>
