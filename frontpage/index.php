...
<section class="index-carousel" id="index-carousel">
	<div class="container accordion-backrg carousel-padding ">
        <div class="row">
                    <div id="myCarousel" class="carousel oa-carousel slide">
                     <img class="img-responsive top-left" src="../img/corner_left_top_braces.png"/>  

                     <!-- Carousel items -->
                        <div class="carousel oa-carousel slide" id="eventCarousel" data-interval="0">
